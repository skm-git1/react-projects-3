    ...
    return(
        <>
            ...
            <div className="card info-card">
                ...
                <h5>That caffien&apos;s half life is about 5 hours?</h5>
                <p>This means that after 5 hours, half the caffine you consumed is still in your system,
                    keeping you alert longer! So if you drink a coffee with 200 mg of caffine, 5 hours later, 
                    you&apos;ll still have 100 mg of caffine in your system.
                </p>
            </div>
        </>
    )
